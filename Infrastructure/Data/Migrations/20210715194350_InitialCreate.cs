        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Surtaxes_SurtaxId",
                        column: x => x.SurtaxId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CapitalGainsTax = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    SurtaxAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    TotalTaxLiaility = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaxLiabilities_Surtaxes_SurtaxId",
                        column: x => x.SurtaxId,
                        principalTable: "Surtaxes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaxLiabilities_SurtaxId",
